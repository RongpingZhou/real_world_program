...
"""
# The code is from https://github.com/google-deepmind/dqn_zoo/blob/master/dqn_zoo/atari_data.py
...
_ATARI_DATA = {
    ...
    'zaxxon': (32.5, 9173.3),
    'flappybird': (3, 100), # modified by Rongping Zhou, guesss the average score 100 from https://flappybird.io/leaderboard/, get the human score data 2311 from https://cyberscore.me.uk/charts/168804
}
...
def get_env_id(game: str) -> str:
  """Returns the environment ID for the given Atari game."""
  match game:
    case 'FlappyBird':
      return 'flappybird'
    case 'AlienNoFrameskip-v4':
      return 'alien'
    case 'AmidarNoFrameskip-v4':
      return 'amidar'
    case 'AssaultNoFrameskip-v4':
      return 'assault'
    case 'AsterixNoFrameskip-v4':
      return 'asterix'
    case 'AsteroidsNoFrameskip-v4':
      return 'asteroids'
    case 'AtlantisNoFrameskip-v4':
      return 'atlantis'
    case 'BankHeistNoFrameskip-v4':
      return 'bank_heist'
    case 'BattleZoneNoFrameskip-v4':
      return 'battle_zone'
    case 'BeamRiderNoFrameskip-v4':
      return 'beam_rider'
    case 'BerzerkNoFrameskip-v4':
      return 'berzerk'
    case 'BowlingNoFrameskip-v4':
      return 'bowling'
    case 'BoxingNoFrameskip-v4':
      return 'boxing'
    case 'BoxingNoFrameskip-v4':
      return 'boxing'
    case 'BreakoutNoFrameskip-v4':
      return 'breakout'
    case 'CentipedeNoFrameskip-v4':
      return 'centipede'
    case 'ChopperCommandNoFrameskip-v4':
      return 'chopper_command'
    case 'CrazyClimberNoFrameskip-v4':
      return 'crazy_climber'
    case 'DefenderNoFrameskip-v4':
      return 'defender'
    case 'DemonAttackNoFrameskip-v4':
      return 'demon_attack'
    case 'DoubleDunkNoFrameskip-v4':
      return 'double_dunk'
    case 'EnduroNoFrameskip-v4':
      return 'enduro'
    case 'FishingDerbyNoFrameskip-v4':
      return 'fishing_derby'
    case 'FreewayNoFrameskip-v4':
      return 'freeway'
    case 'FrostbiteNoFrameskip-v4':
      return 'frostbite'
    case 'GopherNoFrameskip-v4':
      return 'gopher'
    case 'GravitarNoFrameskip-v4':
      return 'gravitar'
    case 'HeroNoFrameskip-v4':
      return 'hero'
    case 'IceHockeyNoFrameskip-v4':
      return 'ice_hockey'
    case 'JamesbondNoFrameskip-v4':
      return 'jamesbond'
    case 'KangarooNoFrameskip-v4':
      return 'kangaroo'
    case 'KrullNoFrameskip-v4':
      return 'krull'
    case 'KungFuMasterNoFrameskip-v4':
      return 'kung_fu_master'
    case 'MontezumaRevengeNoFrameskip-v4':
      return 'montezuma_revenge'
    case 'MsPacmanNoFrameskip-v4':
      return 'ms_pacman'
    case 'NameThisGameNoFrameskip-v4':
      return 'name_this_game'
    case 'PhoenixNoFrameskip-v4':
      return 'phoenix'
    case 'PitfallNoFrameskip-v4':
      return 'pitfall'
    case 'PongNoFrameskip-v4':
      return 'pong'
    case 'PrivateEyeNoFrameskip-v4':
      return 'private_eye'
    case 'QbertNoFrameskip-v4':
      return 'qbert'
    case 'RiverraidNoFrameskip-v4':
      return 'riverraid'
    case 'RoadRunnerNoFrameskip-v4':
      return 'road_runner'
    case 'RobotankNoFrameskip-v4':
      return 'robotank'
    case 'SeaquestNoFrameskip-v4':
      return 'seaquest'
    case 'SkiingNoFrameskip-v4':
      return 'skiing'
    case 'SolarisNoFrameskip-v4':
      return 'solaris'
    case 'SpaceInvadersNoFrameskip-v4':
    ...
    case 'TimePilotNoFrameskip-v4':
      return 'time_pilot'
    case 'TutankhamNoFrameskip-v4':
      return 'tutankham'
    case 'UpNDownNoFrameskip-v4':
      return 'up_n_down'
    case 'VentureNoFrameskip-v4':
      return 'venture'
    case 'VideoPinballNoFrameskip-v4':
      return 'video_pinball'
    case 'WizardOfWorNoFrameskip-v4':
      return 'wizard_of_wor'
    case 'YarsRevengeNoFrameskip-v4':
      return 'yars_revenge'
    case 'ZaxxonNoFrameskip-v4':
      return 'zaxxon'
